...
<div class="container-fluid">
  ...
  <div class="card mt-4 mb-4">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="{{route(auth()->user()->level.'.storeFasilitas')}}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
            <div class="row">
              ...
              <input name="fasilitas" type="text" class="form-control" id="exampleFormControlInput2" placeholder="Nama Fasilitas">
              </div>
              <div class="col">
                <label for="exampleFormControlInput2">Jumlah</label>
                <input name="jumlah" type="number" class="form-control" id="exampleFormControlInput2" placeholder="Jumlah Fasilitas">
              </div>
            </div>
          </div>
