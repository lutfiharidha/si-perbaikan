  ...
  <div class="card mt-4 mb-4">
    <div class="card">
      <div class="card-header">
        <i class="fas fa-table mr-1"></i>Update Kerusakan Fasilitas
      </div>
      <div class="card-body">
        <form method="POST" action="{{route('sekolah.updateKerusakan', $kerusakan)}}" enctype="multipart/form-data">
          @csrf
          {{ method_field('PUT') }}
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input class="form-control" id="rupiah" name="biaya" type="text" placeholder="Biaya Perbaikan" value="{{ $kerusakan->biaya }}" readonly>
                        <br>
                        ...
                        @if($kerusakan->status == 'Pending')
                          ...
                          @else
                            <div class="form-group">
                              <label for="exampleFormControlInput2">Status</label>
                              <input class="form-control" placeholder="Biaya Perbaikan" value="{{ $kerusakan->status }}" readonly>
                            </div>
                          @endif
